VALUE
coth_exp_identity(VALUE x, VALUE prec)
{
	...
	{
		y = rb_Rational(rb_funcall(t, succ, 0), rb_funcall(t, pred, 0));
	...
	{
		y = rb_funcall(rb_funcall1(t, '+', BIG_ONE), div, 2, rb_funcall1(t, '-', BIG_ONE), prec);
	}
	return y;
}
