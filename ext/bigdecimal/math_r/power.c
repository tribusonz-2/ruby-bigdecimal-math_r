 ...
 * @param x [Numeric] Numerical argument
 * @param y [Numeric] Numerical argument
 * @param prec [Integer] Arbitrary precision
 * @return [BigDecimal] Real solution
 * @raise [ArgumentError] Occurs when +prec+ is not a positive integer.
 * @raise [TypeError] Occurs when +x+ is not a numeric class.
 * @raise [TypeError] Occurs when +y+ is not a numeric class.
 * @since 0.2.0
 */
static VALUE
 ...
 * @param w [Numeric] Numerical argument
 * @param prec [Integer] Arbitrary precision
 * @return [Complex] Complex solution
 * @raise [ArgumentError] Occurs when +prec+ is not a positive integer.
 * @raise [TypeError] Occurs when +z+ is not a numeric class.
 * @raise [TypeError] Occurs when +w+ is not a numeric class.
 * @since 0.2.0
 */
static VALUE
...
InitVM_Power(void)
{
	...
	rb_define_module_function(rb_mPower, "pow", __impl_power_pow, 3);
	rb_define_module_function(rb_mPower, "cpow", __impl_power_cpow, 3);
