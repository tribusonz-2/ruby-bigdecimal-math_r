...
VALUE cosh_exp_identity(VALUE x, VALUE prec);
...
VALUE coth_exp_identity(VALUE x, VALUE prec);
...
VALUE csch_exp_identity(VALUE x, VALUE prec);
...
VALUE sech_exp_identity(VALUE x, VALUE prec);
...
VALUE sinh_exp_identity(VALUE x, VALUE prec);
...
VALUE tanh_exp_identity(VALUE x, VALUE prec);
